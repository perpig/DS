...
//	辅助函数:
	BinTreeNode<ElemType> *CopyTree(BinTreeNode<ElemType> *copy);
// 复制二叉树
...
template <class ElemType>
BinTreeNode<ElemType> *BinaryTree<ElemType>::CopyTree(BinTreeNode<ElemType> *copy)
